...
public class RequestHandler {
   ...
   * CSV to load.
   */
  public static Route loadCsv = (request, response) -> {
    ...
    try {
      ...
      return "{\"filepath\": \"" + filepath + "\", \"message\": \"CSV file loaded successfully.\"}";
    } catch (IOException | IllegalArgumentException e) {
      e.printStackTrace();
      response.status(500); // HTTP 500 Internal Server Error
      return "{\"filepath\": \"" + filepath + "\", \"message\": \"Failed to load CSV file: "
          + e.getMessage() + "\"}";
    }
  };
   ...
   */
  public static Route viewCsv = (request, response) -> {
    String filepath = request.queryParams("filepath");
    boolean headers = "yes".equalsIgnoreCase(request.queryParams("headers"));
    Creator creator = new Creator();
   ...
   */
  public static Route searchCsv = (request, response) -> {
    String filepath = request.queryParams("filepath");
    boolean headers = "yes".equalsIgnoreCase(request.queryParams("headers"));
    Creator creator = new Creator();
